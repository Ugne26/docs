...
<CardGroup cols={3}>
  <Card title="Google Calendar" icon="google" iconType="sharp-solid" color="#000000">
    Link up to 5 Google Calendar accounts to your Mirathis profile.
  </Card>
  <Card title="Apple Calendar" icon="apple" iconType="sharp-solid" color="#000000">
    Sync up to 5 iCloud Calendar accounts with Mirathis.
  </Card>
  <Card title="Outlook Calendar" icon="microsoft" iconType="sharp-solid" color="#000000">
...
- "Set up a meeting with sarah@company.com at 2pm including a Zoom link."
